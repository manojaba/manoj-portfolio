            ...
            <div>
                ...
                <div className='xl:flex xl:gap-[125px] w-full '>
                    ...
                    <div className='xl:w-2/3 '>
                        ...
                        <img className='mb-[32px]' src='./images/detail/entertainment/desktop.png'></img>
                        <img className='mb-[64px] md:mb-[80px] xl:mb-[64px]' src='./images/detail/entertainment/mobile.png'></img>
                    </div>
                </div>
